...
class CreateRefund extends Feature
{
    /**
     ...
     * debug files will created with section Refund in config file and Attributes 
    ...
    {
        parent::__construct('Refund', $configParams, $paymentManager);
    }
}
