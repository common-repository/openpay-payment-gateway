...
class Capture extends Feature
{
     ...
     * debug files will created with section Capture in config file and Attributes 
    ...
    {
        parent::__construct('Capture', $configParams, $paymentManager);
    }
}
