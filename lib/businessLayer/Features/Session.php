...
class Session extends Feature
{
     ...
     * debug files will created with section Session in config file and Attributes 
    ...
    {
        parent::__construct('Session', $configParams, $paymentManager);
    }
}
