...
use GuzzleHttp7\ClientInterface;
use GuzzleHttp7\Exception\RequestException;
use GuzzleHttp7\Psr7\MultipartStream;
use GuzzleHttp7\Psr7\Request;
...
class OrdersApi
{
     ...
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp7\Promise\PromiseInterface
     */
     ...
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp7\Psr7\Request
     */
    protected function ordersLimitsGetRequest($origin = null)
    {
        ...
        if (isset($_tempBody)) {
            ...
            if ($httpBody instanceof \stdClass && $headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp7\json_encode($httpBody);
            }
            ...
            if ($multipart) {
                ...
                $httpBody = \GuzzleHttp7\json_encode($formParams);

            } else {
                // for HTTP post (form)
                $httpBody = \GuzzleHttp7\Psr7\Query::build($formParams);
            }
        }
        ...
        $query = \GuzzleHttp7\Psr7\Query::build($queryParams);
        return new Request(
            'GET',
